...
The easiest way to get started with a pipeline is to install the [markdown pipeline](https://github.com/opensouls/community/tree/main/library/pipelines/markdown) into your own soul.
