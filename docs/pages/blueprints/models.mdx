...
- `gpt-4-0125-preview`: Points to `gpt-4-0125-preview`.
...
## gpt-4-vision-preview model for images

The following models support gpt-4-vision-preview

- `gpt-4o`
- `gpt-4-turbo`
- `exp/firellava-13b`

Here's an example of how to use a gpt-4-vision-preview model to describe an image:
...
? The name of your custom model. This is the name you'll use to access the model. fireworks-gpt-4-vision-preview
...
const [withDialog, dialog] = await externalDialog(
  workingMemory,
  "say hi", 
  { model: "treetop/fireworks-gpt-4-vision-preview" }
)
```
