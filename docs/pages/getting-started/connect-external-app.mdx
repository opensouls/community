...
This one is harder to test live, but we can check the logs in the debugger to confirm that it's working:
...
And that's it! You've successfully connected Graham's soul to Telegram and made him more interesting by having him send you bad jokes at random times. If you want to see the final code, you can find it [here](https://github.com/opensouls/community/tree/main/demos/telegram/graham).
